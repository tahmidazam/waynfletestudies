...
this study. The scripts, functions, interview transcript, figures and
the processed dataset can be found in the study's repository:
...
[6](#electroencephalography)](#electroencephalography)

[Neural networks [7](#neural-networks)](#neural-networks)

[Experimental method [8](#experimental-method)](#experimental-method)

[Compiling a training dataset
[8](#compiling-a-training-dataset)](#compiling-a-training-dataset)

[Electrode indexing [8](#electrode-indexing)](#electrode-indexing)

[Filtering [9](#filtering)](#filtering)

[Mu and beta frequency isolation
[9](#mu-and-beta-frequency-isolation)](#mu-and-beta-frequency-isolation)

[Artefact correction [10](#artefact-correction)](#artefact-correction)

[Independent component analysis
[11](#independent-component-analysis)](#independent-component-analysis)

[Epoching and time-locking
[11](#epoching-and-time-locking)](#epoching-and-time-locking)

[Network setup and optimisation
[11](#network-setup-and-optimisation)](#network-setup-and-optimisation)

[The dropout layer [11](#_Toc104123065)](#_Toc104123065)

[The long short-term memory layer
[13](#the-long-short-term-memory-layer)](#the-long-short-term-memory-layer)

[The softmax layer [13](#the-softmax-layer)](#the-softmax-layer)

[Early stopping [13](#early-stopping)](#early-stopping)

[Results [14](#results)](#results)

[Further work [15](#further-work)](#further-work)

[Conclusion [16](#conclusion)](#conclusion)

[Acknowledgements [16](#_Toc104123072)](#_Toc104123072)

[Bibliography [21](#bibliography)](#bibliography)

# Table of figures {#table-of-figures .TOC-Heading}

[Figure 1: The prevalence of SLCN \[11\].
[4](#_Ref104104312)](#_Ref104104312)

[Figure 2: Flowchart comparing the pathways of traditional and BCI AAC
communication. [5](#_Ref104108033)](#_Ref104108033)

[Figure 3: Locations of electrodes in \[18\], according to the 10-20
International System \[13\].
[8](#_Toc104122986)](https://mcsoxfordorg-my.sharepoint.com/personal/12tazam_mcsoxford_org/Documents/Waynflete/WS%20FINALFINAL.docx#_Toc104122986)

[Figure 4: ERP of each electrode for L/R imagery
[9](#_Ref104062768)](#_Ref104062768)

[Figure 5: ERPs of L/R imageries with and without mu and beta frequency
isolation. [10](#_Ref104093542)](#_Ref104093542)

[Figure 6: Neural network structure flowchart.
[11](#_Toc104122989)](#_Toc104122989)

[Figure 7: Network training progress without a dropout layer, with a
13-participant dataset. [12](#_Ref104113528)](#_Ref104113528)

[Figure 8: Graph of average network accuracy against dropout layer
probability. [12](#_Ref104098757)](#_Ref104098757)

[Figure 9: Graph of average network accuracy against number of hidden
units. [13](#_Ref104097831)](#_Ref104097831)

[Figure 10: Network training progress post-optimisation with a
13-participant dataset. [14](#_Ref104099186)](#_Ref104099186)

[Figure 11: Network training progress post-optimisation with a single
participant dataset. [14](#_Ref104099202)](#_Ref104099202)

[Figure 12: Examples of incorrectly classified samples.
[15](#_Ref104110748)](#_Ref104110748)

[Figure 13: Table of results for iteration of the number of hidden
units. [17](#_Ref104097823)](#_Ref104097823)

[Figure 14: Table of results for iteration of dropout layer probability.
[17](#_Ref104098750)](#_Ref104098750)

[Figure 15: script that parses through files and compiles the dataset
[19](#_Ref103506879)](#_Ref103506879)

[Figure 16: function that handles network training and testing
[20](#_Ref103615556)](#_Ref103615556)
...
of this project.
  ...
  10                0.5402           0.4253   0.4253   0.4636    0.6667           0.6667   0.6207   0.6514

  20                0.7126           0.6552   0.6897   0.6858    0.6322           0.6667   0.6322   0.6437

  30                0.7241           0.7241   0.6207   0.6896    0.6207           0.6782   0.7471   0.6820

  40                0.6437           0.6897   0.6552   0.6629    0.7356           0.6897   0.6207   0.6820

  50                0.7241           0.7241   0.7011   0.7164    0.6897           0.6897   0.6897   0.6897

  60                0.6897           0.6437   0.6552   0.6629    0.6667           0.6897   0.7356   0.6973

  70                0.5977           0.6782   0.7011   0.6590    0.6552           0.7011   0.7011   0.6858

  80                0.7356           0.6207   0.6207   0.6590    0.7126           0.6667   0.7126   0.6973

  90                0.7471           0.7241   0.7241   0.7318    0.6322           0.6667   0.7011   0.6667

  100               0.6897           0.6667   0.6897   0.6820    0.6782           0.7356   0.7011   0.7050
  -----------------------------------------------------------------------------------------------------------

[]{#_Ref104097823 .anchor}Figure 13: Table of results for iteration of
the number of hidden units.

  -------------------------------------------------------------------------
  dropout layer       accuracy                       
  probability                                        
  ------------------- ---------- --------- --------- ----------------------
                      trial 1    trial 2   trial 3   average

  0                   0.7241     0.5632    0.5287    0.6053

  0.1                 0.7011     0.7011    0.6437    0.6820

  0.2                 0.6782     0.6782    0.6782    0.6782

  0.3                 0.7011     0.6897    0.6207    0.6705

  0.4                 0.6667     0.7011    0.7126    0.6935

  0.5                 0.6552     0.7011    0.6437    0.6667

  0.6                 0.6552     0.6552    0.6322    0.6475

  0.7                 0.6437     0.6552    0.6667    0.6552

  0.8                 0.4368     0.6322    0.7011    0.5900

  0.9                 0.4368     0.4368    0.6437    0.5058
  -------------------------------------------------------------------------

[]{#_Ref104098750 .anchor}Figure 14: Table of results for iteration of
...
[]{#_Ref103506879 .anchor}Figure 15: Script that parses through files
and compiles the dataset.
...
testingIncorrectPred = trainingPredictions \~=
dataset.training.responses;
...
[]{#_Ref103615556 .anchor}Figure 16: Function that handles network
